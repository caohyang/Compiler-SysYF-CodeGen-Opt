...
//void ComSubExprEli::remove_relevant_instr(Value *val, std::set<Instruction *, cmp_expr> &bb_set) {
...
//void ComSubExprEli::insert_relevant_instr(Value *val, std::set<Instruction *, cmp_expr> &bb_set) {
